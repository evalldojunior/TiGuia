...
class SubAreaMentorViewController: UIHostingController<SubAreaMentorView> {

    required init?(coder: NSCoder) {
        super.init(coder: coder,rootView: SubAreaMentorView(subAreasEscolhidas: AreaMentorView.mentor.subAreas));
    }
